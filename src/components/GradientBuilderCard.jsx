// src/components/GradientBuilderCard.jsx
...
const GradientBuilderCard = ({ color, colorInfo, index, moveCard, isExpanded, onToggleExpand }) => {
    ...
    const generateGradientColors = () => {
        if (!color) {
            // Fallback gradient until a color is selected
        ...
        try {
            ...
            if (useHarmony) {
                ...
                // Single color gradient (light to dark)
  ...
  <rect width="400" height="400" fill="url(#grad)" />
    ...
    return (
        <DashboardCard
            ...
            previewContent={
                <div style={{ ...gradientStyle, height: '80px', width: '100%' }}></div>
            }
        >
            <Card.Body>
                {/* Gradient Preview */}
